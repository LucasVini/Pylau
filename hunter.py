...
class SearchDeviceWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.btn_unicast = QPushButton("Buscar por IP Range")
    ...
    def init_device(self):
        dialog = InitDevAccountDialog(self)
        if dialog.exec_() == QDialog.Accepted:
            ...
            # Aqui você poderia chamar a SDK para inicializar o dispositivo com esses dados
            QMessageBox.information(self, "Sucesso", "Inicialização enviada.")
